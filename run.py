...
def get_stock_values(data):
    """
    Match stock numbers with headings from the worksheet.
    """
...
stock_data = main()  # Step 1: run your program and get new stock data
stock_values = get_stock_values(stock_data)  # Step 2: call get_stock_values with that data

print("Recommended stock for next market:")
print(stock_values)
